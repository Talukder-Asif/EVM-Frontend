    ...
    <div>
        ...
        <div className="flex flex-col-reverse md:flex-row md:justify-around gap-5 p-5 items-center min-h-[100vh] py-10">
          <div className="md:w-1/2">
            <h1 className="text-3xl md:text-5xl  text-white font-bold">
              Welcome to the
              <span className="text-[#11a9f5]"> Computer Club </span> Voting
              Platform
            </h1>
            ...
            <button className="btn shadow border-[#11a9f5] bg-[#11a9f5] text-[#002a3f] hover:text-[#11a9f5] hover:border-[#002a3f] hover:bg-[#002a3f] duration-500 m-2  hover:scale-110 text-sm hover:shadow-[#11a9f5]">
              View Elections
            </button>
            <button className="btn shadow border-[#11a9f5] bg-[#11a9f5] text-[#002a3f] hover:text-[#11a9f5] hover:border-[#002a3f] hover:bg-[#002a3f] duration-500 m-2  hover:scale-110 text-sm hover:shadow-[#11a9f5]">
              Admin Login
      ...
      <div className="my-14 max-w-screen-xl m-auto p-10">
        <div>
          ...
          <div className="w-[15%] h-1 bg-[#002a3f] rounded-full m-auto"> </div>
          ...
          <div className="my-10 grid md:grid-cols-3 gap-10">
            ...
            <div className="card rounded-lg relative bg-base-100 border border-[#002a3f] group hover:shadow-[0px_15px_30px_rgba(0,42,63,0.4)] hover:border-transparent hover:scale-105 transform transition duration-500 hover:bg-[#002a3f] hover:text-white">
              ...
              <div className="card-body">
                ...
                <p>
                  Students can log in using their university credentials and
        ...
        <div className="max-w-screen-xl m-auto grid md:grid-cols-2 gap-5 items-center">
          <div>
            <h3 className="text-white font-light text-3xl md:text-6xl leading-snug">
              Why Choose <br />Our <span className="font-bold text-[#11a9f5]">Voting</span> <br />
              Platform?
            </h3>
          </div>

          <div className="bg-[#00131c73] py-12 px-10 md:rounded-tr-[50px]">
            <h4 className="text-center text-2xl md:text-3xl mb-4 text-white">Robust Security</h4>
            <p className="text-[#dbdbdb] md:text-justify">We prioritize your privacy with end-to-end encryption, ensuring every vote is securely transmitted and anonymous. Multi-factor authentication (MFA) adds an extra layer of protection for admin logins and voter access, preventing unauthorized entry. Our platform also maintains data integrity with stringent protocols, safeguarding against tampering and duplicate voting.</p>
          </div>

          <div className="bg-[#00131c73] py-12 px-10 md:rounded-bl-[50px]">
            <h4 className="text-center text-2xl md:text-3xl mb-4 text-white">Real-Time Transparency</h4>
            <p className="text-[#dbdbdb] md:text-justify">Our platform provides real-time election updates, keeping everyone informed as votes are cast. Instant results build trust, while detailed post-election reports and an audit trail ensure a transparent and fair voting process.</p>
          </div>

          <div className="bg-[#00131c73] py-12 px-10 md:rounded-br-[50px]">
            <h4 className="text-center text-2xl md:text-3xl mb-4 text-white">Seamless User Experience</h4>
            <p className="text-[#dbdbdb] md:text-justify">Designed for ease of use, our platform offers a straightforward, user-friendly interface. It’s mobile-optimized, allowing voting from any device, anywhere, ensuring maximum participation and accessibility.</p>
          </div>
